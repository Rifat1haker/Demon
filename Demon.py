#!/use/bin/env python3
"""
Tool Name: Demon Phishing
Author: Mueid Mursalin Rifat
GitHub: https://github.com/rifat1haker
"""
	...
	try:
		...
		if (status == 200):
			...
			if (gh_version > version):
				print("\n\033[1;92mA new update (Version {}) is available for DEMON.\033[0;0m\n".format(gh_version))
			else:
				print("\nAlready up to date.\n")
		else:
...
Usage:
    python3 Demon.py [-h] [-p PORT] [-u] [-v] [-r]
